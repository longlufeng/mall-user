...
//	
//	@Autowired
//	SessionChk sessionChk;
//
//	/**
//	 * 重写addCorsMappings()解决跨域问题 配置：允许http请求进行跨域访问
//	 *
//	 * @param registry
//	 */
//	@Override
...
//
//	/**
//	 * 重写addInterceptors()实现拦截器 配置：要拦截的路径以及不拦截的路径
//	 *
//	 * @param registry
//	 */
//	@Override
...
//		InterceptorRegistration registration = registry.addInterceptor(sessionChk);
